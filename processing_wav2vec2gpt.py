...
"""
Speech processor class for Wav2Vec2GPT
"""
import warnings
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        try:
            ...
            warnings.warn(
                ...
                "removed in v5. Please add `'tokenizer_class': 'GPT2Tokenizer'`"
            ...
            tokenizer = GPT2Tokenizer.from_pretrained(pretrained_model_name_or_path, **kwargs)
