...
class GPT2LMfromEmbedding(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        ### labels=None, # not used in this model
        use_cache=None,
...
class Wav2Vec2GPTModel(Wav2Vec2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.rnn_compressor = nn.GRU(input_size=config.hidden_size, 
                                     ...
                                     num_layers=1, 
                                     # bias=False,
                                     # dropout=0.1, # already in the front of GPT
                                     batch_first=True)
    ...
    def forward(
        ...
        word_embeddings = torch.gather(output_from_RNN[:,:,:-1], 
                                       1, 
                                       attention_mask.unsqueeze(-1).expand(-1,-1,self.n_hidden))
